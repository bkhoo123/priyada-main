...
const DanceRegistration = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response) {
        alert("You have successfully registered for this class. Your request is pending approval. You should hear back from Priyanka shortly.");
        router.push("/");
      }
    } catch (error) {
      console.error(error);
      alert("Sorry, there was an error. Failed to submit form. Please try again.");
    }
  };
      ...
      <section className='flex flex-col items-center w-full h-full bg-cover bg-opacity-50 bg-center' style={{ backgroundImage: "url('/splash_page/Splash_pager.jpg')" }}>
        ...
        <div className='flex flex-col justify-center bg-black text-cream w-[40%] border-none rounded-md shadow-xl p-8 m-20 border-2 '>
          <div className='flex justify-center'>
            <h1 className='text-3xl font-bold mb-4 text-cream'>Register For Dance Lessons</h1>
          </div>
          ...
          <form onSubmit={handleSubmit}
            ...
            <label className='my-4'>
              ...
              <select value={danceClassId} onChange={handleChange} name='danceClassId' className='rounded-md text-black text-lg p-2 bg-lightcream shadow-xl'>
            ...
            <label className='mt-5 mb-4'>
              ...
              <input value={age} name='age' onChange={handleChange} className='rounded-md mt-2 mb-4 w-20 bg-lightcream border-b-2 border-black outline-none shadow-xl p-2 text-black text-lg'
                placeholder="Ex. 6" />
            </label>
            ...
            <label className='mb-4 mt-5'>
              ...
              <input value={location} name='location' onChange={handleChange} className="rounded-md mt-2 mb-4 w-full text-black font-semibold outline-none text-lg border-b-2 border-black shadow-xl p-2 bg-lightcream"
            ...
            <label className='mt-5 mb-4'>
              ...
              <textarea
                ...
                className='flex justify-center outline-none text-black text-lg border-2 border-black p-4 focus-none resize-none mt-4 mb-4 rounded-md shadow-xl w-full bg-lightcream'
