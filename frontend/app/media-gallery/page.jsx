        ...
        <>
            ...
            <div className=''>
                <div className="bg-black px-32">
                  ...
                  <div className="fixed top-[30%] flex flex-col justify-start items-start self-start text-cream gap-3 py-10">
